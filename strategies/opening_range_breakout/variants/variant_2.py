...
def opening_range_breakout(
    ...
    and uses a price-percentage-based trailing stop for exits.
    
    Variant 2: Reversion threshold based on price percentage
    - reversion_threshold = high_water_mark * reversion_multiple
    - This makes the exit threshold proportional to the current price level
    - Higher prices have larger absolute stop distances (but same percentage)
    ...
    4. Exit via trailing stop: reversion from high_water_mark by (price * reversion_multiple)
    ...
    Args:
        ...
        params: Strategy parameters dictionary with keys:
            ...
            - reversion_multiple (float): Exit threshold as percentage of high water mark (default: 0.5)
    ...
    Example:
        ...
        ...     'breakout_buffer': 1.0,
        ...     'reversion_multiple': 0.01,  # 1% of price
        ...     'exit_time': '15:45',
        ...     'max_positions': 1
        ... }
    ...
    for symbol, bar in current_bars.items():
        ...
        # Exit logic: Trailing stop based on price percentage (Variant 2)
            ...
            if position.direction == 'long':
                ...
                # Variant 2: Reversion threshold = high_water_mark * reversion_multiple
                # This makes the stop proportional to price level (percentage-based)
                reversion_threshold: float = metadata['high_water_mark'] * reversion_multiple
                ...
                # Variant 2: Reversion threshold = low_water_mark * reversion_multiple
